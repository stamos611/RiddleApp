...
using RiddleApp.Data;
using RiddleApp.Models;

namespace RiddleApp.Controllers
{
    public class RiddlesController : Controller
    {
        ...
        {
            return View("Index",await _context.Riddle.Where(c=>c.RiddleQuestion.Contains(Search)).ToListAsync());
        }
